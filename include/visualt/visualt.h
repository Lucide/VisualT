 ...
 * - In @enumerator{VTFIT} mode, the Sprite will be resized (thus @e reallocated) to fit the content in @c utf8String.
 * - In @enumerator{VTCROP} mode, everything that goes outside the active Sprite is instead dropped. The parsing is done
 * the same as in @func{vtInitializeStrings}.
 *
 * @code
